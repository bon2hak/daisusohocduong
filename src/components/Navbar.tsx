            ...
            <div className="flex items-center gap-1.5">
              {currentRole === "super_admin" ? (
                ...
                <div className="flex items-center gap-1 bg-amber-600 text-white px-2.5 py-1 rounded-md text-xs font-black shadow-xs border border-amber-400">
                  ...
                  <span>🟠 Cố vấn: {currentUser.name}</span>
                </div>
              ) : currentRole === "ambassador" ? (
                <div className="flex items-center gap-1 bg-sky-500 text-white px-2.5 py-1 rounded-md text-xs font-black shadow-xs border border-sky-300">
